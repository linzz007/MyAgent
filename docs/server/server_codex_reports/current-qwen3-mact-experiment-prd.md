...
6. 同步更新：MACT package latest runtime preflight、E4 readiness、current patent section、completion gap audit 已刷新；两个 Qwen3 endpoint 常驻，`0,1 -> 8001` 与 `2,3 -> 8000`，后续除非用户要求或切模型，不释放显存。
