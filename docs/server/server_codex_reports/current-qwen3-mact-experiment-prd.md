...
| MACT blind full200 seeded run | in_progress | full200 目录已从 core100 seed；WTQ `169/200`，TabFact/CRT `100/200` |
...
|---|---:|---|---|
| WTQ | 169/200 | running; row101-row123 ok, row124 context overflow, row125-row132 ok, row133 context overflow, row134-row155 ok, row156 context overflow, row157-row169 ok, last id `nu-4092` | `run_wtq_resume.sh` |
...
| `wtq_mact_full200.jsonl` | WTQ 169/200 raw，row124/row133/row156 为 context overflow failure，后台仍在继续 |
...
| 周期性 Git checkpoint | ongoing | core100 已 final 推送；full200 已按 seed/row101/104/109/116/120/126/133/138/145/150/152/153/164/165/167/169 节点同步 ledger/doc |
...
| P0 | WTQ full200 补到 200 并 checkpoint | in progress: 当前 169/200 |
