...
| MACT blind full200 seeded run | in_progress | full200 目录已从 core100 seed；WTQ `150/200`，TabFact/CRT `100/200` |
...
|---|---:|---|---|
| WTQ | 150/200 | running; row101-row123 ok, row124 context overflow, row125-row132 ok, row133 context overflow, row134-row150 ok, last id `nu-4291` | `run_wtq_resume.sh` |
...
| `wtq_mact_full200.jsonl` | WTQ 150/200 raw，row124/row133 为 context overflow failure，后台仍在继续 |
...
| 周期性 Git checkpoint | ongoing | core100 已 final 推送；full200 已按 seed/row101/104/109/116/120/126/133/138/145 节点推送，当前准备同步 row150 |
...
| P0 | WTQ full200 补到 200 并 checkpoint | in progress: 当前 150/200 |
