...
| `crt_mact_core100.jsonl` | CRT 63/100 raw，本地继续增长 |
...
最新 checkpoint 会继续推送到 MACT `main`。当前准备同步 CRT row63。
...
|---:|---|---|
| P0 | CRT core100 从 63/100 跑到 100/100 | `crt_mact_core100.jsonl`、CRT logs |
