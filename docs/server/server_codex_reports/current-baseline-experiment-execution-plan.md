...
| No deterministic shortcuts | `run_ablation_no_deterministic_shortcuts50.sh` | same 4567 endpoint policy | running; WTQ `50/50` complete, TabFact started by 2026-08-14 10:17 CST |
