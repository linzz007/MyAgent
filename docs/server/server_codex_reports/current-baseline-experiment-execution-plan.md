...
| No strong verification | `run_ablation_no_strong50.sh` | same 4567 endpoint policy | running; WTQ `50/50` complete, TabFact started at `10/50` by 2026-08-14 09:48 CST |
