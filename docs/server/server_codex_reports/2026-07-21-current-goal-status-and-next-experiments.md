...
2026-07-23 09:03:05 CST TabFact resume checkpoint:
...
2026-07-23 09:36:36 CST TabFact resume checkpoint:
...
2026-07-23 11:04:33 CST CRT resume checkpoint:

| dataset | MACT rows | failed | missing | last id | runner |
|---|---:|---:|---:|---|---|
| WTQ | 100/100 | 2 | 2 | `nu-216` | complete |
| TabFact | 100/100 | 0 | 0 | `tabfact-test-6673` | complete |
| CRT | 55/100 | 0 | 0 | `crt-239` | active pid `346671` |
